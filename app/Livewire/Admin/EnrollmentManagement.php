...
class EnrollmentManagement extends Component
{
    ...
    public function getEnrollmentsProperty()
    {
        ...
        if ($this->campInstanceFilter) {
            $query->where('camp_instance_id', $this->campInstanceFilter);
        }
    ...
    {
        return view('livewire.admin.enrollment-management')->layout('components.layouts.app');
    }
}
