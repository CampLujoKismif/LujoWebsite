<x-layouts.public>
    ...
    <div class="min-h-screen mx-auto max-w-2xl px-4 sm:px-6 lg:px-0 py-20" style="padding-top: 164px;">
        <!-- Hero Card -->
        <div class="relative bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-12 mb-12">
            ...
            <h1 class="text-4xl font-extrabold text-gray-900 text-center mb-2">{{ $instance->camp->display_name }}</h1>
            <div class="flex flex-col sm:flex-row justify-center gap-6 mt-6 mb-2">
                <div class="flex-1 text-center">
                    <div class="text-xs text-gray-500 uppercase tracking-wider">Age/Grade</div>
                ...
                <div class="flex-1 text-center">
                    <div class="text-xs text-gray-500 uppercase tracking-wider">Dates</div>
                    <div class="text-lg font-semibold text-gray-800 mt-1">
                ...
                <div class="hidden sm:block w-px bg-gray-200"></div>
                <div class="flex-1 text-center">
                    <div class="text-xs text-gray-500 uppercase tracking-wider">Fee</div>
                    <div class="text-lg font-semibold text-gray-800 mt-1">
                        @if($instance->price)
                    ...
                    @if($instance->max_capacity)
                        <div class="text-xs text-gray-500 mt-1">{{ $instance->available_spots }} spots left</div>
                    @endif
                </div>
            </div>
            <div class="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                ...
                @endif
                <a href="{{ route('home') }}#faq" class="inline-block rounded-full border border-blue-600 px-8 py-3 text-base font-semibold text-blue-600 hover:bg-blue-50 transition">Learn More</a>
            </div>
        </div>
        ...
        @if($instance->theme_description)
            <div class="mb-12">
                ...
                <p class="text-gray-700 leading-relaxed">{{ $instance->theme_description }}</p>
            </div>
        @endif
                    ...
                    @foreach(json_decode($instance->schedule_data) as $time => $activity)
                        <li class="mb-8 ml-6">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                                ...
                                <span class="text-gray-700 text-base">{{ $activity }}</span>
                            </div>
                        </li>
                    @endforeach
                </ol>
        ...
        @if($instance->additional_info)
            <div class="mb-12">
                ...
                <div class="text-gray-700 leading-relaxed">{!! nl2br(e($instance->additional_info)) !!}</div>
            </div>
        @endif
