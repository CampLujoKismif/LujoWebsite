            ...
            <div class="relative top-10 mx-auto p-5 border w-full max-w-4xl shadow-lg rounded-md bg-white">
                <div class="mt-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Camper Information -->
                        <div>
                            <h4 class="text-md font-medium text-gray-900 mb-3">Camper Information</h4>
                        ...
                        <!-- Camp Information -->
                        <div>
                            <h4 class="text-md font-medium text-gray-900 mb-3">Camp Information</h4>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <div class="space-y-2">
                        ...
                        <!-- Form Completion -->
                        <div>
                            <h4 class="text-md font-medium text-gray-900 mb-3">Form Completion</h4>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <div class="space-y-2">
                                    <div><span class="font-medium">Forms Complete:</span> 
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $selectedEnrollment->forms_complete ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    @if($selectedEnrollment->notes)
                        <div class="mt-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                <p class="text-sm text-gray-700 whitespace-pre-wrap">{{ $selectedEnrollment->notes }}</p>
                            </div>
                        </div>
                    @endif

                    <div class="mt-6 flex justify-end">
                        <button wire:click="$set('showDetailsModal', false)" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                            Close
                        </button>
                    </div>
                </div>
    ...
    @if($showStatusModal && $selectedEnrollment)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
                <div class="mt-3">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Update Enrollment Status</h3>
                    <form wire:submit.prevent="updateStatus">
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <button type="button" wire:click="$set('showStatusModal', false)" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                Cancel
                            </button>
            ...
            <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
                <div class="mt-3">
                    ...
                    <form wire:submit.prevent="recordPayment">
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <button type="button" wire:click="$set('showPaymentModal', false)" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                Cancel
                            </button>
