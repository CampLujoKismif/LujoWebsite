...
new #[Layout('components.layouts.auth')] class extends Component {
    ...
    public function login(): void
    {
        ...
        $this->redirectIntended(default: route('dashboard.home', absolute: false), navigate: true);
    }
...
<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Welcome Back!')" :description="__('Sign in to access your camp dashboard')" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <button
            type="submit"
            class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
    ...
    <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
        <div class="flex items-center">
            ...
            <p class="text-sm text-blue-800 dark:text-blue-200">
                <strong>Need help?</strong> Contact camp staff at (580) 353-8370
            </p>
        </div>
    </div>
</div>
